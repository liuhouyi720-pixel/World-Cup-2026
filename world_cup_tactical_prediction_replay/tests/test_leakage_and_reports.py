...
def test_report_complete_and_grounded():
    p=engine().predict({"match_id":"x","kickoff":"2026-07-01","stage":"Final","group":"","home_team":"Spain","away_team":"France"},FormService());md=report_markdown(p);assert "xT" in md and "数据置信度" in md and "伤病" not in md
